...
#include "sci_types.h"
    ...
    /**
     * Exec a scilab command
     * @param cmd the Scilab command
     * @param msg the Scilab command error message, "" if no error
     * @param cmd the Scilab command error stack, "" if no error
     * @return status, 0 : OK
     */
