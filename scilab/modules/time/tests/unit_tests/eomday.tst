...
errmsg = msprintf(gettext("%s: Wrong type for input argument #%d: Must be in %s.\n"), "eomday", 1, errarg);
assert_checkerror("eomday(""toto"", 1)", errmsg);
errmsg = msprintf(gettext("%s: Wrong value for input argument #%d: Integer numbers expected.\n"), "eomday", 1);
assert_checkerror("eomday(12.5, 1)", errmsg);
errmsg = msprintf(gettext("%s: Wrong value for input argument #%d: Real numbers expected.\n"), "eomday", 1);
...
errmsg = msprintf(gettext("%s: Wrong size for input argument #%d: Must be of the same dimensions of #%s.\n"),"eomday", 2, "1");
assert_checkerror("eomday(1, [1 2])", errmsg);
errmsg = msprintf(gettext("%s: Wrong value for input argument #%d: Must be in range [%d, %d].\n"),"eomday",2,1,12);
