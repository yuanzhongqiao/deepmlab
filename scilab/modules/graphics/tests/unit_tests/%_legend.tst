...
if execstr("%_legend([e1],[''XXXX'';''YYY''])","errcatch")==0 then pause,end
if execstr("%_legend([e1,e2],[''XXXX''])","errcatch")==0 then pause,end

if execstr("%_legend(e1,[])","errcatch")==0 then pause,end
