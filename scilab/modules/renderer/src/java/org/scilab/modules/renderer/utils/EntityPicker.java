...
public class EntityPicker {
    ...
    public Integer pick(Integer figureUid, Integer posX, Integer posY) {
        ...
        Integer[] matchingAxes = AxesHandler.clickedAxes(figureUid, position);
        if (matchingAxes == null) {
            return null;
        }
    ...
    public static double[] getSegment(Integer figureUid, Integer uid, int index, int x, int y) {
        final Integer axes = (new ObjectSearcher()).searchParent(uid, GraphicObjectProperties.__GO_AXES__);
    ...
    public PickedPoint pickPoint(Integer uid, int px, int py) {
        ...
        Integer[] matchingAxes = AxesHandler.clickedAxes(figUid, position);
        if (matchingAxes == null) {
            return point;
        }
    ...
    public LegendInfo pickLegend(Integer figure, Integer[] position) {
        Integer[] matchingAxes = AxesHandler.clickedAxes(figure, position);
        if (matchingAxes == null) {
            return null;
        }
        ...
        Integer legend = null;
        Integer axes = null;
        for (Integer searchAxes : matchingAxes) {
            legend = LegendHandler.searchLegend(searchAxes);
            if (legend != null) {
                axes = searchAxes;
                break;
            }
    ...
    public static AxesHandler.axisTo pickLabel(Integer figure, Integer[] pos) {
        ...
        Integer matchingAxes[] = AxesHandler.clickedAxes(figure, pos);
        if (matchingAxes == null) {
            return null;
        }
        Double[] corners;
    ...
    public SurfaceInfo pickSurface(Integer figure, Integer[] mousePos) {
        Integer[] matchingAxes = AxesHandler.clickedAxes(figure, mousePos);

        for (Integer uid : matchingAxes) {
