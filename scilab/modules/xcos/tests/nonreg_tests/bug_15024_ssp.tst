...
scs_m1 = scicosDiagramToScilab(SCI + "/modules/xcos/tests/nonreg_tests/bug_15024.ssp");
scs_m = scs_m1;
...
scicosDiagramToScilab(TMPDIR + "/bug_15024.ssp", scs_m);
scs_m2 = scicosDiagramToScilab(TMPDIR + "/bug_15024.ssp");
scs_m = scs_m2;
