...
DIFFERENTIAL_EQUATIONS_IMPEXP STR_IERDASSL C2F(ierdassl);
DIFFERENTIAL_EQUATIONS_IMPEXP STR_IERDASSL C2F(ierajf);
...
extern STR_IERDASSL C2F(ierdassl);
extern STR_IERAJF C2F(ierajf);
