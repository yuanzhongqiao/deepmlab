...
//daskr
typedef void(*dasrkr_g_t)(int*, double*, double*, double*, int*, double*, double*, int*);
...
extern void C2F(ddaskr)(dassl_f_t, int*, double*, double*, double*, double*, int*, double*, double*, int*, double*, int*, int*, int*, double*, int*, void* /*dassl_jac_t or daskr_pjac_t*/, daskr_psol_t, dasrkr_g_t, int*, int*);
DIFFERENTIAL_EQUATIONS_IMPEXP void daskr_g(int*, double*, double*, double*, int*, double*, double*, int*);
