...
[yy,nn]=%_daskr([y0,y0d],t0,t,atol,rtol,"res1",ng,"grd1",info,"psol1","pjac1");
...
[yy,nn]=%_daskr([y0,y0d],t0,t,atol,rtol,"res1",ng,"grd1",info);
...
deff("[rts]=grd1(t,y,yd)","rts=[((2*log(y)+8)/t-5)*y;log(y)-2.2491]")
...
info=list([],0,[],[],[],0,[],1,[],0,1,[],[],1);
atol=1.d-6;rtol=0;ng=2;
[yy,nn]=%_daskr([y0,y0d],t0,t,atol,rtol,res1,ng,"grd1",info,psol,pjac);
assert_checkalmostequal(nn(1),2.47,0.001);
y0=yy(2,2);y0d=yy(3,2);t0=nn(1);t=[3,4,5,6];
[yy,nn]=%_daskr([y0,y0d],t0,t,atol,rtol,res1,ng,"grd1",info,psol,pjac);
assert_checkalmostequal(nn(1),2.5,0.001);
...
[yy,nn]=%_daskr([y0,y0d],t0,t,atol,rtol,"res2","jac2",ng,"grd2",info);
...
[yy,nn]=%_daskr([y0,y0d],t0,t,atol,rtol,res2,jac2,ng,"grd2",info);
deff("s=grd2(t,y,yd)","s=y(1)")
[yy,nn]=%_daskr([y0,y0d],t0,t,atol,rtol,res2,jac2,ng,grd2,info);

// Same problem, with psol and pjac example routines

info=list([],0,[],[],[],0,[],1,[],0,1,[],[],1);
[yy,nn]=%_daskr([y0,y0d],t0,t,atol,rtol,res2,jac2,ng,"grd2",info,"psol1","pjac1");
...
funcprot(prot);
[yy,nn]=%_daskr([y0,y0d],t0,t,atol,rtol,res2,jac2,ng,"grd2",info,psol,pjac);
...
[yy,nn,hotd]=%_daskr([y0,y0d],t0,t,atol,rtol,"res2","jac2",ng,"grd2",info);
t01=nn(1);t=100:20:200;[pp,qq]=size(yy);y01=yy(3:4,qq);y0d1=yy(4:5,qq);
[yy,nn,hotd]=%_daskr([y01,y0d1],t01,t,atol,rtol,"res2","jac2",ng,"grd2",info,hotd);
