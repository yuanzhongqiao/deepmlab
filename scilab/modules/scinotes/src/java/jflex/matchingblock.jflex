...
openK = ("if" | "for" | "while" | "select" | "try" | "function" | "switch" | "arguments" | "classdef" | "properties" | "enumeration" | "methods")
openKx = {openK}{spec}+
...
esolcK = ("fi" | "rof" | "elihw" | "tceles" | "yrt" | "noitcnuf" | "hctiws" | "stnemugra" | "fedssalc" | "seitreporp" | "noitaremune" | "sdohtem")
esolcKx = {spec}{esolcK}
xesolcK = {esolcK}{spec}
