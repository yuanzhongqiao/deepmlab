...
assert_checkfalse(execstr("eigs(As, %f)", "errcatch") == 0);
refMsg = msprintf(_("%s: Wrong type for input argument #%d: Must be in %s.\n"), "speigs", 2, sci2exp(["double", "sparse"]));
assert_checkerror("eigs(As, %f)", refMsg);


refMsg = msprintf(_("%s: Wrong size for input argument #%d: Must be of the same dimensions of #%d or empty.\n"), "speigs", 2, 1);
assert_checkfalse(execstr("eigs(As, %nan)", "errcatch") == 0);
assert_checkerror("eigs(As, %nan)", refMsg);

assert_checkfalse(execstr("eigs(As, %inf)", "errcatch") == 0);
assert_checkerror("eigs(As, %inf)", refMsg);

assert_checkfalse(execstr("eigs(As, %eps)", "errcatch") == 0);
assert_checkerror("eigs(As, %eps)", refMsg);

assert_checkfalse(execstr("eigs(As, [1 2])", "errcatch") == 0);
assert_checkerror("eigs(As, [1 2])", refMsg);
...
refMsg = msprintf(_("%s: Wrong type for input argument #%d: Must be in %s.\n"), "speigs", 3, sci2exp("double"));
assert_checkfalse(execstr("eigs(As, [], %f)", "errcatch") == 0);
assert_checkerror("eigs(As, [], %f)", refMsg);

refMsg = msprintf(_("%s: Wrong value for input argument #%d: Real numbers expected.\n"), "speigs", 3);
assert_checkfalse(execstr("eigs(As, [], 2*%i)", "errcatch") == 0);
assert_checkerror("eigs(As, [], 2*%i)", refMsg);

refMsg = msprintf(_("%s: Wrong value for input argument #%d: Positive numbers expected.\n"), "speigs", 3);
assert_checkfalse(execstr("eigs(As, [], -15)", "errcatch") == 0);
assert_checkerror("eigs(As, [], -15)", refMsg);

refMsg = msprintf(_("%s: Wrong value for input argument #%d: Integer numbers expected.\n"), "speigs", 3);
assert_checkfalse(execstr("eigs(As, [], 5.6)", "errcatch") == 0);
assert_checkerror("eigs(As, [], 5.6)", refMsg);

refMsg = msprintf(_("%s: Wrong type for input argument #%d: Must be a scalar.\n"), "speigs", 3);
assert_checkfalse(execstr("eigs(As, [], [1 2])", "errcatch") == 0);
assert_checkerror("eigs(As, [], [1 2])", refMsg);
...
assert_checkfalse(execstr("eigs(As, [], 4, %f)", "errcatch") == 0);
assert_checkerror("eigs(As, [], 4, %f)", refMsg);
...
refMsg = msprintf(_("%s: Wrong type for input argument #%d: Must be a scalar.\n"), "speigs", 4);
assert_checkfalse(execstr("eigs(As, [], 4, [])", "errcatch") == 0);
assert_checkerror("eigs(As, [], 4, [])", refMsg);

refMsg = msprintf(_("%s: Wrong value for input argument #%d: Nan are not allowed.\n"), "speigs", 4);
assert_checkfalse(execstr("eigs(As, [], 4, %nan)", "errcatch") == 0);
assert_checkerror("eigs(As, [], 4, %nan)", refMsg);
...
assert_checkfalse(execstr("eigs(As, [], 4, which)", "errcatch") == 0);
assert_checkerror("eigs(As, [], 4, which)", refMsg);
...
assert_checkfalse(execstr("eigs(As, [], 4, which, %nan)", "errcatch") == 0);
assert_checkerror("eigs(As, [], 4, which, %nan)", refMsg);

opts.var = %nan;
refMsg = msprintf(_("%s: Wrong type for input argument: If A is a matrix, use opts with tol, maxiter, ncv, resid, cholB.\n"), "eigs");
assert_checkfalse(execstr("eigs(A, [], 4, which, opts)", "errcatch") == 0);
assert_checkerror("eigs(A, [], 4, which, opts)", refMsg);

assert_checkfalse(execstr("eigs(As, [], 4, which, opts)", "errcatch") == 0);
assert_checkerror("eigs(As, [], 4, which, opts)", refMsg);
...
assert_checkfalse(execstr("eigs(As, [], 4, which, opts)", "errcatch") == 0);
refMsg = msprintf(_("%s: Wrong type for input argument #%d: Must be in %s.\n"), "speigs", 9, sci2exp(["double", "boolean"]));
assert_checkerror("eigs(As, [], 4, which, opts)", refMsg);
